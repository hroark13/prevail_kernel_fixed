...
static struct struct_marks_ver_mark marks_ver_mark = {
  ...
  .this=(&marks_ver_mark + 0x03000000),
  .first_size = 256*1024*1024,
  .first_start_addr = 0x03000000,
  .second_size = 0,
  .second_start_addr = 0
};
...
{
  return _buf_log_main+0x03000000;
}
void * p_radio_addr(void)
{
  return _buf_log_radio+0x03000000;
}
void * p_events_addr(void)
{
  return _buf_log_events+0x03000000;
}
void * p_system_addr(void)
{
  return _buf_log_system+0x03000000;
}
...
static int __init logger_init(void)
{
	...
	plat_log_mark.p_radio  = _buf_log_radio+0x03000000;
