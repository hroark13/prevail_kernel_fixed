...
#define SA0_CONNECTED_TO_VCC	(0x02)
#define SA0_CONNECTED_TO_GND	(0x00)


#ifdef CONFIG_MACH_REALITY2
#define SA0_CONFIG				(SA0_CONNECTED_TO_VCC)
#else
#define SA0_CONFIG				(SA0_CONNECTED_TO_GND)
#endif



#define KR3DM_SLAVE_ADDRESS			(SENS_ADD|SA0_CONFIG)

#define	SENS_ADD		0x10
#define DEBUG			1
#define I2C_M_WR				0x00
#define I2C_DF_NOTIFY			0x01
#define KR3DM_I2C_NAME "kr3dm"
...
#define KR3DM_READ_ACCEL_XYZ           _IOWR(KR3DM_IOC_MAGIC,26,short)
