...
NORET_TYPE void panic(const char * fmt, ...)
{
	...
	/*
          * Since init binary doesn't exist on rootfs or unable to mount root FS,
          * do not enter ramdump mode but reset phone.
	  */
	if(strncmp(buf, "Attempted to kill init!", 23) == 0)
