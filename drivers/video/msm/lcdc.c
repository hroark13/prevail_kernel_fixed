...
#if !(defined(CONFIG_MACH_RANT3) || defined(CONFIG_MACH_VINO) || defined(CONFIG_MACH_GIOS)/*|| defined(CONFIG_MACH_ROOKIE) || defined(CONFIG_MACH_GIO) || defined(CONFIG_MACH_ESCAPE)*/)
