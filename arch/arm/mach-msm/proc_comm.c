...
void msm_proc_comm_reset_modem_now(void)
{
  ...
  {
    Quattro_vendor1_id->off_charging_off = 0x11;  //bypass long key routine on CP side
  }
...
void msm_proc_comm_modem_normal_reset(void)
{
  uint param1 = 0x0;
  uint param2 = 0x0;

  Quattro_vendor1_id->off_charging_off = 0x11;  //bypass long key routine on CP side
  msm_proc_comm(PCOM_RESET_CHIP_IMM, &param1, &param2);
}

EXPORT_SYMBOL(msm_proc_comm_modem_normal_reset);
