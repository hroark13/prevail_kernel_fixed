...
#if defined(CONFIG_MACH_RANT3) || defined(CONFIG_MACH_VINO) || defined(CONFIG_MACH_REALITY2) || defined(CONFIG_MACH_ESCAPE) || defined(CONFIG_MACH_ROOKIE) || defined(CONFIG_MACH_GIO) || defined(CONFIG_MACH_GIOS)
