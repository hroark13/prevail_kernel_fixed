...
extern const UINT16 MELFAS_40_binary_nLength;
extern const  UINT8 MELFAS_40_binary[];
extern const UINT16 MELFAS_50_binary_nLength;
extern const  UINT8 MELFAS_50_binary[];
...
*/
	...
	nRet = mms100_ISC_download( (const UINT8*) MELFAS_40_binary, (const UINT16)MELFAS_40_binary_nLength , 0);
	if (nRet)
		goto fw_error;
#endif
#if MELFAS_ISC_2CHIP_DOWNLOAD_ENABLE
...
int mms100_ISC_download_binary_file(INT32 hw_ver)
{
	int nRet;
    int i;
	//UINT8  *pBinary[2] = {&MELFAS_40_binary,NULL};
	//UINT16 nBinary_length[2] ={MELFAS_40_binary_nLength ,0};
...
nRet = mms100_ISC_download( (const UINT8*) MELFAS_50_binary, (const UINT16)MELFAS_50_binary_nLength , 0);
else
