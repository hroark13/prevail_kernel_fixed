...
static const struct s5k4ca_i2c_reg_conf const lens_roll_off_tbl[] = {
...
static const struct s5k4ca_i2c_reg_conf const pll_setup_tbl[] = {
...
/* Refresh Sequencer */
static const struct s5k4ca_i2c_reg_conf const sequencer_tbl[] = {
