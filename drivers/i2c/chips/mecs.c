...
static atomic_t	l_flag;	// iamaj 
static short pval;
static short lightval;	// iamaj 
...
static int __init ecompass_init(void)
{
	...
	input_set_abs_params(ecs_data_device, ABS_DISTANCE, -3, 3, 0, 0);

#if !(defined (CONFIG_MACH_GIO) || defined (CONFIG_MACH_RANT3) || defined (CONFIG_MACH_VINO) || defined (CONFIG_MACH_GIOS))
	input_set_abs_params(ecs_data_device, ABS_PRESSURE, 0, 2000, 0, 0);	// iamaj
#endif
